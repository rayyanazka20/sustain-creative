...
import {useCreatePortfolio,} from "@/api/getPortofolio.jsx"; // pastikan path sesuai
import {useCategory} from "@/api/getCatefory.jsx";

export default function PortfolioDetailModal({ onClose }) {
    ...
    return (
        <div className="fixed inset-0 backdrop-blur-xs bg-opacity-50 flex items-center justify-center z-50">
            <section className="max-w-4xl w-full p-6 mx-auto bg-gray-50 rounded-lg shadow-lg relative">
                ...
                <button
                    onClick={onClose}
                    className="absolute top-3 right-4 text-black text-2xl font-bold hover:text-gray-300"
                >
                    ×
                </button>
      ...
      rounded-md focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                            >
                                ...
                                {isError && <option disabled>Gagal memuat kategori</option>}
